    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'hasło' ? 'http://127.0.0.1:4000/api/v1/uzytkownicy/updateMyPassword' : 'http://127.0.0.1:4000/api/v1/uzytkownicy/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              // wykonuje podzapytanie do bazy
              method: 'PATCH',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:4000/api/v1/platnosci/checkout-sesja/".concat(wycieczkaId));
...
var zakupPrzycisk = document.getElementById('zarezerwuj-wycieczke'); // delegacje
